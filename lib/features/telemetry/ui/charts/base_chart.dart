...
class BaseProgressionChart extends StatelessWidget {
  ...
  final List<LineTooltipItem?> Function(List<LineBarSpot> touchedSpots) tooltipBuilder;
  ...
  static List<TouchedSpotIndicatorData> _buildTouchedIndicators(
    ...
    return spotIndexes.map((index) {
      return TouchedSpotIndicatorData(
        FlLine(color: indicatorLineColor.withOpacity(0.4), strokeWidth: 2, dashArray: [4, 4]),
        FlDotData(
          show: true,
          getDotPainter: (spot, percent, bar, idx) {
            return FlDotCirclePainter(
              radius: 6, // Enlarges slightly
              color: bar.color ?? indicatorLineColor, // Fills with the line's specific color!
              strokeWidth: 2,
        ...
        LineChartData(
          ...
          lineTouchData: LineTouchData(
            ...
            getTouchedSpotIndicator: (barData, spotIndexes) {
              return _buildTouchedIndicators(barData, spotIndexes, context.textPrimary, context.cardBackground);
            },
              ...
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (value, meta) {
                  return Padding(
                    ...
                    child: bottomLabelBuilder(value), // INJECTS CUSTOM X LABELS!
                  );
                },
              ),
            ),
